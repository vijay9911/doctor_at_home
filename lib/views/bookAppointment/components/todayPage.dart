...
class TodayPageScreen extends StatefulWidget {
  const TodayPageScreen({Key? key}) : super(key: key);

  @override
  State<TodayPageScreen> createState() => _TodayPageScreenState();
}

class _TodayPageScreenState extends State<TodayPageScreen> {
  List time = [
    "05:00 PM",
    "05:30 PM",
    "06:00 PM",
